...
SCPresq="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3RoZW9uZWpwYXMvZ29sZGVudnBzL21hc3Rlci9yZXF1ZXN0"
SUB_DOM='base64 -d'
...
fun_ip
wget -O /usr/bin/trans https://raw.githubusercontent.com/theonejpas/goldenvps/master/Install/trans &> /dev/null
msg -bar2
